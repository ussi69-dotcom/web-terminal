          ...
          class n {
            static computeLink(e, t, i, r) {
              ...
              for (; (d = o.exec(c)); ) {
                ...
                l.push({ range: p, text: e, activate: r });
              }
              return l;
            }
            ...
            static _mapStrIdx(e, t, n, i) {
              ...
              for (; i; ) {
                ...
                for (let n = s; n < e.length; ++n) {
                  ...
                  if (
                    o.getWidth() &&
                    ((i -= s.length || 1), n === e.length - 1 && "" === s)
                  ) {
                    const e = r.getLine(t + 1);
                    e &&
                      e.isWrapped &&
                      (e.getCell(0, o), 2 === o.getWidth() && (i += 1));
                  }
                  if (i < 0) return [t, n];
                }
                (t++, (s = 0));
        ...
        e.WebLinksAddon = class {
          ...
          activate(e) {
            ...
            this._linkProvider = this._terminal.registerLinkProvider(
              new t.WebLinkProvider(this._terminal, i, this._handler, n),
            );
          }
          dispose() {
            var e;
